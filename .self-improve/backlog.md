...
| SI-003 | Unattended safety guardrails (budget caps, auto-pause on N consecutive QA failures, kill switch) | feature | Operator,Gatekeeper / J3,J4 | `config.json` carries `loop.guardrails`; `/improve-run` honors caps & auto-pauses; documented | M | 8 | done ✓ cycle 3 |
